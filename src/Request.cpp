...
/*   Updated: 2024/10/25 17:57:39 by bdelamea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Request::pnc_request_line(std::istringstream & iss) {
	...
	if (!(_request_line["method"] == "GET" || _request_line["method"] == "POST" || _request_line["method"] == "DELETE")
		|| std::find(_host._allowedMethods.begin(), _host._allowedMethods.end(), _request_line["method"]) == _host._allowedMethods.end())
